...
public class APPCodeDemo {
    ...
    public static void main(String[] args){
        ...
        String host = "https://ocrdiy.market.alicloudapi.com";//http://dm-51.data.aliyun.com
        String path = "/api/predict/ocr_sdt";///rest/160601/ocr/ocr_idcard.json
        String appcode = "cabee09b4f904201a4f049604a6cc930";
        String imgFile = "/Users/hyong/Desktop/2011634191885_.pic.jpg";
